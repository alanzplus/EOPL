...
(define tests
  (test-suite "A4:"
              ...
              (test-suite "value-of-ri"
                          ...
                          (test-equal? "case2" ((value-of-ri empty-env-ds extend-env-ds apply-env-ds closure-ds-ri apply-closure-ds-ri) '((lambda (x) x) 5)) 5)
                          (test-equal? "case3" ((value-of-ri empty-env-fn extend-env-fn apply-env-fn closure-ds-ri apply-closure-ds-ri) '((lambda (x) x) 5)) 5)
                          (test-equal? "case4" ((value-of-ri empty-env-ds extend-env-ds apply-env-ds closure-fn-ri apply-closure-fn-ri) '((lambda (x) x) 5)) 5))
))
