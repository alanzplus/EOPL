void *exprr__ex__, *addressr__ex__, *envr__ex__, *contr__ex__, *vr__ex__, *closurer__ex__;
...
struct env {
  ...
  union {
    ...
    struct { void *_val; void *_savedr__m__env; } _extend;
  } u;
};
...
struct closure {
  ...
  union {
    struct { void *_body; void *_env; } _procedure;
  } u;
};
...
struct kt {
  ...
  union {
    ...
    struct { void *_xr2; void *_savedr__m__env; void *_savedr__m__cont; } _mult;
    struct { void *_v; void *_savedr__m__cont; } _multr__m__inner;
    struct { void *_savedr__m__cont; } _subr1;
    struct { void *_savedr__m__cont; } _zero;
    struct { void *_conseq; void *_alt; void *_savedr__m__env; void *_savedr__m__cont; } _if;
    struct { void *_savedr__m__cont; } _ifr__m__conseq;
    struct { void *_savedr__m__cont; } _ifr__m__alt;
    struct { void *_savedr__m__cont; } _letcc;
    struct { void *_savedr__m__env; void *_savedr__m__cont; void *_vr__m__exp; } _throw;
    struct { void *_savedr__m__cont; void *_v; } _throwr__m__inner;
    struct { void *_savedr__m__env; void *_savedr__m__cont; void *_body; } _let;
    struct { void *_savedr__m__cont; } _letr__m__inner;
    struct { void *_savedr__m__env; void *_savedr__m__cont; void *_rand; } _app;
    struct { void *_v; void *_savedr__m__cont; } _appr__m__inner;
    struct { void *_savedr__m__cont; } _closure;
  } u;
};
...
void *ktr_if(void *conseq, void *alt, void *savedr__m__env, void *savedr__m__cont);
void *ktr_ifr__m__conseq(void *savedr__m__cont);
void *ktr_ifr__m__alt(void *savedr__m__cont);
void *ktr_letcc(void *savedr__m__cont);
void *ktr_throw(void *savedr__m__env, void *savedr__m__cont, void *vr__m__exp);
